...
CERN (from CMTSITE)
DaVinci_v35r1_no_config (from PROJECT) excludes [DaVinci_v35r1_config]
DaVinci_v35r1_root (from PROJECT) excludes [DaVinci_v35r1_no_root]
DaVinci_v35r1_cleanup (from PROJECT) excludes [DaVinci_v35r1_no_cleanup]
DaVinci_v35r1_prototypes (from PROJECT) excludes [DaVinci_v35r1_no_prototypes]
DaVinci_v35r1_with_installarea (from PROJECT) excludes [DaVinci_v35r1_without_installarea]
DaVinci_v35r1_without_version_directory (from PROJECT) excludes [DaVinci_v35r1_with_version_directory]
DaVinci_v35r1 (from PROJECT)
...
DAVINCI_without_version_directory (from PROJECT) excludes [DAVINCI_with_version_directory]
...
ANALYSIS_without_version_directory (from PROJECT) excludes [ANALYSIS_with_version_directory]
...
STRIPPING_without_version_directory (from PROJECT) excludes [STRIPPING_with_version_directory]
x86_64 (from package CMT)
slc65 (from package CMT)
gcc481 (from package CMT)
Unix (from package CMT) excludes [WIN32 Win32]
----------> CMTPATH
# Add path /afs/cern.ch/user/i/ibabusch/public/MinimalMergeEvent/cmtuser/DaVinci_v35r1 from initialization
# Add path /afs/cern.ch/lhcb/software/releases/DAVINCI/DAVINCI_v35r0 from ProjectPath
# Add path /afs/cern.ch/lhcb/software/releases/ANALYSIS/ANALYSIS_v12r2 from ProjectPath
# Add path /afs/cern.ch/lhcb/software/releases/STRIPPING/STRIPPING_v8r2 from ProjectPath
# Add path /afs/cern.ch/lhcb/software/releases/PHYS/PHYS_v18r2 from ProjectPath
# Add path /afs/cern.ch/lhcb/software/releases/REC/REC_v16r2 from ProjectPath
# Add path /afs/cern.ch/lhcb/software/releases/LBCOM/LBCOM_v15r2 from ProjectPath
# Add path /afs/cern.ch/lhcb/software/releases/LHCB/LHCB_v37r2 from ProjectPath
# Add path /afs/cern.ch/lhcb/software/releases/GAUDI/GAUDI_v25r1 from ProjectPath
...
# Add path /afs/cern.ch/sw/lcg/releases/LCGCMT/LCGCMT_68 from ProjectPath
